...
export default function RevenueChart({ data }: RevenueChartProps) {
  ...
  return (
    <div className="bg-[#141428] border border-[#2a2a4a] rounded-xl p-5">
      <h3 className="text-[#e8e8f0] text-sm font-semibold mb-4">Revenue — Budget vs Actual</h3>
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={chartData} barCategoryGap="20%">
          ...
          <Bar dataKey="Budget" fill="#4a7dff" opacity={0.4} radius={[4, 4, 0, 0]} />
          <Bar dataKey="Actual" fill="#00d4aa" radius={[4, 4, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
